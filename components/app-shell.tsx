...
const fadeTransition: Transition = { duration: 0.65, ease: 'easeOut' };
...
function Hero({ userEmail }: { userEmail: string }) {
  return (
    <section id="dashboard" className="mx-auto max-w-7xl px-4 pb-8 pt-5 sm:px-6 lg:px-8 lg:pt-8">
      <motion.div initial="hidden" animate="visible" variants={fadeVariants} transition={fadeTransition} className="glass rounded-[2rem] p-5 sm:p-8 lg:p-10">
